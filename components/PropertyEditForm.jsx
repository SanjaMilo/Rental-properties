...
const PropertyEditForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        //* Check for any null values (from database, like the 'rates') and make sure that those Form fields value are set as an empty string instead of null (cannot be null)
  ...
  const handleChange = (e) => {
    ...
    if (name.includes(".")) {
      const [outerKey, innerKey] = name.split("."); // location (outerKey) street (innerKey) (e.g. location.street)
  ...
  //? PUT method (to update, edit). On the Form we are going to use onSubmit function, because we cannot use attribute action and method ('get' or 'post').
  //* We are not going to edit the images here, but in the profile, your listings
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            ...
            <div>
              <input
                ...
                value="Sea View"
                className="mr-2"
                checked={fields.amenities.includes("Sea View")}
                onChange={handleAmenitiesChange}
              />
              <label htmlFor="amenity_sea_view">Sea View</label>
            </div>
            <div>
              <input
                type="checkbox"
